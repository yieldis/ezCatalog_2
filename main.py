...
def configure_catalog(path):
    ...
    with open('README.md', 'r+') as f:
        ...
        txt = re.sub(f"https://EDIorg.github.io/ezCatalog_2/public/demo.html", new_demo_page, txt)
        ...
        txt = re.sub(f"https://github.com/EDIorg/ezCatalog_2/blob/master/.github/workflows/build_catalog.yml", new_url, txt)
        f.seek(0)
        f.write(txt)
        f.truncate()
